let i = {code:"1", res: null};

console.log(i);
//i.res!==null || res.length!=undefined ||
if( i.length >0){
    console.log(i)
}
...
for( let i = 0 ; i < subcatids_of_catids_arr.length ; i++){

    for( let j = 0 ; j < subcatids_of_catids_arr[i].sub_cat_ids.length ; j ++){
        console.log(subcatids_of_catids_arr[i].sub_cat_ids[j]);
    }
}
        ...
        if (index_i < subcatids_of_catids_arr.length) {
            ...
            async function subcatids_of_catids_recursive(index_j){
                if(index_j < subcatids_of_catids_arr[index_i].sub_cat_ids.length){
                    try {
                        // for(let i=0; i < subcatids_of_catids_arr[i])
                        let param_obj = { 
...
asj(params);
    ...
    //  console.log(arr[0].sub_cat_ids[0]);